...
public class DomainError extends RuntimeException {
    public static final Supplier<DomainError> BAD_REQUEST_SYSTEM = () -> DomainError.System.badRequest("argument required");
    public static final Function<String, Supplier<DomainError>> MISSING_CONFIG_SYSTEM = (prop) -> () -> DomainError.System.badRequest("config property " + prop + " required");
    ...
    public static JsonArray dumpStack(Throwable cause) {
        return cause != null && cause.getStackTrace() != null
                ? Arrays.stream(cause.getStackTrace()).map(StackTraceElement::toString).limit(STACK_TRACE_LINES.get()).collect(JsonArray::new, JsonArray::add, JsonArray::addAll)
                : new JsonArray();
    }
    ...
    public interface User {
        ...
        static DomainError unavailableForLegalReasons(int mode, String pattern, Object... args) {
            ...
            var e = MessageFormatter.arrayFormat(pattern, args);
            if (e.getThrowable() != null) {
                return new DomainError(mode, CODE_UNAVAILABLE_FOR_LEGAL_REASONS, e.getMessage(), null, e.getThrowable());
            }
        ...
        static DomainError networkAuthenticationRequired(int mode, String pattern, Object... args) {
            ...
            var e = MessageFormatter.arrayFormat(pattern, args);
            if (e.getThrowable() != null) {
                return new DomainError(mode, CODE_NETWORK_AUTHENTICATION_REQUIRED, e.getMessage(), null, e.getThrowable());
            }
    ...
    public record ErrorTuple(int mode, int code, String user, String system, int argument) implements ErrorMaker {
        ...
        public DomainError make(Object... arguments) {
            ...
            if (e != null) {
                return new DomainError(mode, code, u == null ? null : u.getMessage(), s == null ? null : s.getMessage(), e);
            }
        ...
        public DomainError suppress(Object... arguments) {
            ...
            if (e != null) {
                return new DomainError(mode, code, u == null ? null : u.getMessage(), s == null ? null : s.getMessage(), e, true);
            }
            return new DomainError(mode, code, u == null ? null : u.getMessage(), s == null ? null : s.getMessage(), null, true);
        }
    }
}
