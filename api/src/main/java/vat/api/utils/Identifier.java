...
public interface Identifier {
    ...
    static @Nullable Tuple2<@Nullable String, @Nullable String> split(String identifier) {
    ...
    static <I extends Number, V extends Number> String combine(@Nullable I i,
                                                               @Nullable V v,
                                                               Function<I, String> a,
                                                               Function<V, String> b
                                                              ) {
    ...
    static String combine(@Nullable Long i, @Nullable Long v) {
        return combine(i, v, Long::toHexString, Long::toHexString);
    }

    static String combine(@Nullable Long i, @Nullable Integer v) {
    ...
    static Optional<Tuple2<@Nullable Long, @Nullable Integer>> parse84(@Nullable String identifier) {
    ...
    static Optional<Tuple2<@Nullable Long, @Nullable Long>> parse88(@Nullable String identifier) {
        return Optional.ofNullable(identifier)
                       .filter(Predicate.not(String::isBlank))
                       .map(Identifier::split)
                       .map(v -> v
    ...
    static Optional<Tuple2<@Nullable Integer, @Nullable Integer>> parse44(@Nullable String identifier) {
        return Optional.ofNullable(identifier)
                       .filter(Predicate.not(String::isBlank))
                       .map(Identifier::split)
                       .map(v -> v
    ...
    static Optional<Entity.Entry> entry(@Nullable String identifier) {
        return parse84(identifier)
                .map(v -> Entity.Entry.of(v.v1, v.v2 == null ? -1 : v.v2));

    }

    static Optional<String> entry(Entity.@Nullable Entry entry) {
